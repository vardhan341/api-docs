...
{% api-method-description %}
Updates and existing passportcard. PUT requests require ALL record properties to be submitted with every request. Any missing properties will be cleared or set to false.

...
{% api-method-description %}
Gets a list of businesssettings based on a range of dates, integer or decimal properties.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/sys/businesssettings?BusinessSetting_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}

{% api-method-description %}
Gets one or more businesssetting records based on their Id.
{% endapi-method-description %}
...
Comma-separated list of IDs of every businesssetting to fetch. I.e. [123456,789102,...] 
{% endapi-method-parameter %}
...
{% api-method-description %}
Updates and existing businesssetting. PUT requests require ALL record properties to be submitted with every request. Any missing properties will be cleared or set to false.

...
> 🔒 Requires user role `language-list`
...
{% api-method-description %}
This endpoint allows you to GET a list of languages.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/sys/languages?Language_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}
...
Comma-separated list of IDs of every language to fetch. I.e. [123456,789102,...] 
{% endapi-method-parameter %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/sys/languages/:id" %}
{% api-method-summary %}
One by Id
{% endapi-method-summary %}

{% api-method-description %}
Gets one language record.
{% endapi-method-description %}
...
> 🔒 Requires user role `language-read`


{% api-method method="post" host="https://spaces.nexudus.com/api" path="/sys/languages" %}
{% api-method-summary %}
Create
{% endapi-method-summary %}
...
Required User Roles: `language-delete`
{% endapi-method-description %}
...
> 🔒 Requires user role `language-delete`
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/sys/languages/commands" %}
{% api-method-summary %}
Commands
{% endapi-method-summary %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/sys/languages/runcommand" %}
{% api-method-summary %}
Run Command
{% endapi-method-summary %}

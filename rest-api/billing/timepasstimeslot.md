...
{% api-method-description %}
Gets a list of timepasstimeslots based on the date when they were created or updated.
{% endapi-method-description %}
...
{% api-method-description %}
Updates and existing timepasstimeslot.Required User Role: `timepasstimeslot-edit`
{% endapi-method-description %}
...
{% api-method-path-parameters %}
{% api-method-parameter name="Id" type="integer" required=true %}
The id of the timepasstimeslot to update
{% endapi-method-parameter %}
{% endapi-method-path-parameters %}
...
{% api-method-description %}
Deletes a timepasstimeslot.Required User Roles: `timepasstimeslot-delete`
{% endapi-method-description %}

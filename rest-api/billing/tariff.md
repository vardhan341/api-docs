...
{% api-method-parameter name="DefaultInvoicingDay" type="decimal" required=false %}
...
{% api-method-parameter name="CancellationPeriod" type="decimal" required=false %}
...
{% api-method-parameter name="SubscribersLimit" type="decimal" required=false %}
...
{% api-method-parameter name="DefaultContractTerm" type="decimal" required=false %}
...
{% api-method-parameter name="CancelMemeberAccountAfter" type="decimal" required=false %}
...
{% api-method-parameter name="CheckinPricePlanLimit" type="decimal" required=false %}
...
{% api-method-parameter name="CheckinMonthLimit" type="decimal" required=false %}
...
{% api-method-parameter name="CheckinWeekLimit" type="decimal" required=false %}
...
{% api-method-parameter name="HoursPricePlanLimit" type="decimal" required=false %}
...
{% api-method-parameter name="HoursMonthLimit" type="decimal" required=false %}
...
{% api-method-parameter name="HoursWeekLimit" type="decimal" required=false %}
...
{% api-method-parameter name="BookingMinuteWeekLimit" type="decimal" required=false %}
...
{% api-method-parameter name="BookingMinuteMonthLimit" type="decimal" required=false %}
...
{% api-method-parameter name="InvoiceEvery" type="decimal" required=false %}
...
{% api-method-parameter name="InvoiceEveryWeeks" type="decimal" required=false %}
...
{% api-method-parameter name="AutoCancelAfter" type="decimal" required=false %}
...
{% api-method-parameter name="AdvanceInvoiceCycles" type="decimal" required=false %}
...
{% api-method-parameter name="ProrateDayOfMonth" type="decimal" required=false %}
...
{% api-method-parameter name="ProrateDaysBefore" type="decimal" required=false %}
...
{% api-method-parameter name="ChargeAndExtend" type="decimal" required=false %}
...
{% api-method-parameter name="RaiseInvoiceEvery" type="decimal" required=false %}
...
{% api-method-parameter name="RaiseInvoiceEveryWeeks" type="decimal" required=false %}
...
{% api-method-description %}
Updates and existing tariff.Required User Role: `tariff-edit`
{% endapi-method-description %}
...
{% api-method-description %}
Deletes a tariff.Required User Roles: `tariff-delete`
{% endapi-method-description %}
...
* [TaxRate](https://github.com/Nexudus/api-docs/tree/096184e4d99d0fe4a35601a3440d36ef82f8983d/rest-api/sys/taxrate.md)

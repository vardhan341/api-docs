...
This endpoint allows you to GET a list of paymentgateways based on one or more filter querystring parameters.
...
?PaymentGateway\_SystemId=...
{% endapi-method-parameter %}


{% api-method-parameter name="Business" type="Business" %}
?PaymentGateway\_Business=...
{% endapi-method-parameter %}


{% api-method-parameter name="Name" type="string" %}
?PaymentGateway\_Name=...
{% endapi-method-parameter %}


{% api-method-parameter name="PaymentGatewayType" type="enum" %}
?PaymentGateway\_PaymentGatewayType=...
{% endapi-method-parameter %}
...
{% api-method-parameter name="ConfigurationXml" type="string" %}
?PaymentGateway\_ConfigurationXml=...
{% endapi-method-parameter %}


{% api-method-parameter name="XmlResponse" type="string" %}
?PaymentGateway\_XmlResponse=...
{% endapi-method-parameter %}


{% api-method-parameter name="TransactionFee" type="decimal?" %}
?PaymentGateway\_TransactionFee=...
{% endapi-method-parameter %}


{% api-method-parameter name="FinancialAccount" type="FinancialAccount" %}
?PaymentGateway\_FinancialAccount=...
{% endapi-method-parameter %}


{% api-method-parameter name="TaxRate" type="TaxRate" %}
?PaymentGateway\_TaxRate=...
{% endapi-method-parameter %}
...
{% api-method-description %}
This endpoint allows you to GET a list of paymentgateways.
{% endapi-method-description %}
...
?from\_PaymentGateway\_TransactionFee=...
{% endapi-method-parameter %}
{% api-method-parameter name="TransactionFee" type="decimal" required=false %}
?to\_PaymentGateway\_TransactionFee=...
{% endapi-method-parameter %}
...
{% api-method-description %}
Gets one paymentgateway record.
{% endapi-method-description %}
...
The ID of the paymentgateway to fetch.
{% endapi-method-parameter %}
...
Required User Roles: `paymentgateway-delete`
{% endapi-method-description %}
...
> 🔒 Requires user role `paymentgateway-delete`


## Commands

Commands allow to perform actions against one or more paymentgateway records. Some commands accept only one record while others can run an action for a number of records at the same time.  Each command has metadata with information about how it can be used and the amount of records, if any, it needs to run.
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/billing/paymentgateways/commands" %}
{% api-method-summary %}
Commands
{% endapi-method-summary %}

{% api-method-description %}
Get all commands available to run for paymentgateway records.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/billing/paymentgateways/runcommand" %}
{% api-method-summary %}
Run Command
{% endapi-method-summary %}

...
> 🔒 Requires user role `tariffproduct-list`
...
{% api-method-description %}
This endpoint allows you to GET a list of tariffproducts.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/billing/tariffproducts?TariffProduct_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}
...
Comma-separated list of IDs of every tariffproduct to fetch. I.e. [123456,789102,...] 
{% endapi-method-parameter %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/billing/tariffproducts/:id" %}
{% api-method-summary %}
One by Id
{% endapi-method-summary %}

{% api-method-description %}
Gets one tariffproduct record.
{% endapi-method-description %}
...
{% api-method-path-parameters %}
{% api-method-parameter name="id" type="integer" required=true %}
The ID of the tariffproduct to fetch.
{% endapi-method-parameter %}
{% endapi-method-path-parameters %}
{% endapi-method-request %}
...
> 🔒 Requires user role `tariffproduct-read`


{% api-method method="post" host="https://spaces.nexudus.com/api" path="/billing/tariffproducts" %}
{% api-method-summary %}
Create
{% endapi-method-summary %}
...
{% api-method-description %}
Deletes a tariffproduct.  
  
Required User Roles: `tariffproduct-delete`
{% endapi-method-description %}
...
> 🔒 Requires user role `tariffproduct-delete`
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/billing/tariffproducts/commands" %}
{% api-method-summary %}
Commands
{% endapi-method-summary %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/billing/tariffproducts/runcommand" %}
{% api-method-summary %}
Run Command
{% endapi-method-summary %}

{% api-method method="get" host="https://spaces.nexudus.com/api" path="/billing/productextraservices" %}
{% api-method-summary %}
Find
...
> 🔒 Requires user role `productextraservice-list`
...
{% api-method-description %}
This endpoint allows you to GET a list of productextraservices.
{% endapi-method-description %}
...
{% api-method-description %}
Gets a list of productextraservices based on a range of dates, integer or decimal properties.
{% endapi-method-description %}
...
?to\_ProductExtraService\_CreatedOn=...
{% endapi-method-parameter %}

{% api-method-parameter name="CreatedOn" type="object" required=false %}
?from\_ProductExtraService\_CreatedOn=...
{% endapi-method-parameter %}

{% api-method-parameter name="UpdatedOn" type="object" required=false %}
?to\_ProductExtraService\_UpdatedOn=...
{% endapi-method-parameter %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/billing/productextraservices?ProductExtraService_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}
...
Comma-separated list of IDs of every productextraservice to fetch. I.e. [123456,789102,...] 
{% endapi-method-parameter %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/billing/productextraservices/:id" %}
{% api-method-summary %}
One by Id
{% endapi-method-summary %}

{% api-method-description %}
Gets one productextraservice record.
{% endapi-method-description %}
...
{% api-method-path-parameters %}
{% api-method-parameter name="id" type="integer" required=true %}
The ID of the productextraservice to fetch.
{% endapi-method-parameter %}
{% endapi-method-path-parameters %}
{% endapi-method-request %}
...
> 🔒 Requires user role `productextraservice-read`


{% api-method method="post" host="https://spaces.nexudus.com/api" path="/billing/productextraservices" %}
{% api-method-summary %}
Create
{% endapi-method-summary %}
...
> 🔒 Requires user role `productextraservice-create`
...
{% api-method method="put" host="https://spaces.nexudus.com/api" path="/billing/productextraservices" %}
{% api-method-summary %}
Update
{% endapi-method-summary %}
...
{% api-method method="delete" host="https://spaces.nexudus.com/api" path="/billing/productextraservices/:id" %}
{% api-method-summary %}
Delete
{% endapi-method-summary %}

{% api-method-description %}
Deletes a productextraservice.  
  
Required User Roles: `productextraservice-delete`
{% endapi-method-description %}
...
> 🔒 Requires user role `productextraservice-delete`
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/billing/productextraservices/commands" %}
{% api-method-summary %}
Commands
{% endapi-method-summary %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/billing/productextraservices/runcommand" %}
{% api-method-summary %}
Run Command
{% endapi-method-summary %}

...
{% api-method-description %}
Gets a list of coworkerdiscountcodes based on the date when they were created or updated.
{% endapi-method-description %}
...
{% api-method-parameter name="TimesUsed" type="decimal" required=false %}
...
{% endapi-method-parameter %}
{% api-method-parameter name="TimesUsed" type="int" required=true %}
{% endapi-method-parameter %}
{% api-method-parameter name="ExpiresOn" type="DateTime?" required=false %}
{% endapi-method-parameter %}

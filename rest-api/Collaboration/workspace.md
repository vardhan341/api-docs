...
{% api-method-description %}
 This endpoint allows you to GET a list of workspaces based on one or more filter querystring parameters.
...
{% api-method-parameter name="Administrator" type="Coworker" %}
?Workspace\_Administrator=...
{% endapi-method-parameter %}
...
{% api-method-parameter name="VisibleInMySpaces" type="bool" %}
?Workspace\_VisibleInMySpaces=...
{% endapi-method-parameter %}


{% api-method-parameter name="VisibleByEveryone" type="bool" %}
?Workspace\_VisibleByEveryone=...
{% endapi-method-parameter %}
...
> 🔒 Requires user role `workspace-list`
...
{% api-method-description %}
This endpoint allows you to GET a list of workspaces.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/collaboration/workspaces?Workspace_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}

{% api-method-description %}
Gets one or more workspace records based on their Id.
{% endapi-method-description %}
...
Comma-separated list of IDs of every workspace to fetch. I.e. [123456,789102,...] 
{% endapi-method-parameter %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/collaboration/workspaces/:id" %}
{% api-method-summary %}
One by Id
{% endapi-method-summary %}

{% api-method-description %}
Gets one workspace record.
{% endapi-method-description %}
...
> 🔒 Requires user role `workspace-read`


{% api-method method="post" host="https://spaces.nexudus.com/api" path="/collaboration/workspaces" %}
{% api-method-summary %}
Create
{% endapi-method-summary %}
...
Required User Roles: `workspace-delete`
{% endapi-method-description %}
...
> 🔒 Requires user role `workspace-delete`


## Commands

Commands allow to perform actions against one or more workspace records. Some commands accept only one record while others can run an action for a number of records at the same time.  Each command has metadata with information about how it can be used and the amount of records, if any, it needs to run.
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/collaboration/workspaces/commands" %}
{% api-method-summary %}
Commands
{% endapi-method-summary %}

{% api-method-description %}
Get all commands available to run for workspace records.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/collaboration/workspaces/runcommand" %}
{% api-method-summary %}
Run Command
{% endapi-method-summary %}

...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/content/blogcategories?BlogCategory_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}
...
{% api-method-description %}
Updates and existing blogcategory. PUT requests require ALL record properties to be submitted with every request. Any missing properties will be cleared or set to false.
  
Required User Role: `blogcategory-edit`
{% endapi-method-description %}
...
{% api-method-parameter name="Title" type="string" required="true" %}
{% endapi-method-parameter %}
{% api-method-parameter name="BlogPosts" type="int[]" required="true" %}
{% endapi-method-parameter %}
{% api-method-parameter name="AddedBlogPosts" type="int[]" required="true" %}
{% endapi-method-parameter %}
{% api-method-parameter name="RemovedBlogPosts" type="int[]" required="true" %}
{% endapi-method-parameter %}
{% endapi-method-body-parameters %}
{% endapi-method-request %}
...
Required User Roles: `blogcategory-delete`
{% endapi-method-description %}

...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/content/blogposts?BlogPost_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}
...
{% api-method-description %}
Updates and existing blogpost. PUT requests require ALL record properties to be submitted with every request. Any missing properties will be cleared or set to false.
...
{% api-method-parameter name="Title" type="string" required="true" %}
{% endapi-method-parameter %}
{% api-method-parameter name="SummaryText" type="string" required="true" %}
{% endapi-method-parameter %}
{% api-method-parameter name="FullText" type="string" required="true" %}
{% endapi-method-parameter %}
...
{% endapi-method-parameter %}
{% api-method-parameter name="BlogCategories" type="int[]" required="true" %}
{% endapi-method-parameter %}
{% api-method-parameter name="AddedBlogCategories" type="int[]" required="true" %}
{% endapi-method-parameter %}
{% api-method-parameter name="RemovedBlogCategories" type="int[]" required="true" %}
{% endapi-method-parameter %}
{% api-method-parameter name="CommentsCount" type="int" required="true" %}
{% endapi-method-parameter %}
{% endapi-method-body-parameters %}

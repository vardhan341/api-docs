...
{% api-method-description %}
Gets a list of surveyruns based on a range of dates, integer or decimal properties.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/content/surveyruns?SurveyRun_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}

{% api-method-description %}
Gets one or more surveyrun records based on their Id.
{% endapi-method-description %}
...
Comma-separated list of IDs of every surveyrun to fetch. I.e. [123456,789102,...] 
{% endapi-method-parameter %}

...
{% api-method-description %}
Gets a list of crmboards based on a range of dates, integer or decimal properties.
{% endapi-method-description %}
...
?to\_CrmBoard\_UpdatedOn=...
{% endapi-method-parameter %}

{% api-method-parameter name="UpdatedOn" type="object" required=false %}
?from\_CrmBoard\_UpdatedOn=...
{% endapi-method-parameter %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/crm/crmboards?CrmBoard_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}

{% api-method-description %}
Gets one or more crmboard records based on their Id.
{% endapi-method-description %}
...
Comma-separated list of IDs of every crmboard to fetch. I.e. [123456,789102,...] 
{% endapi-method-parameter %}
...
{% api-method-description %}
Updates and existing crmboard. PUT requests require ALL record properties to be submitted with every request. Any missing properties will be cleared or set to false.

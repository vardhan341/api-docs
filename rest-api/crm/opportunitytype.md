...
{% api-method-description %}
Gets a list of opportunitytypes based on a range of dates, integer or decimal properties.
{% endapi-method-description %}
...
?to\_OpportunityType\_UpdatedOn=...
{% endapi-method-parameter %}

{% api-method-parameter name="UpdatedOn" type="object" required=false %}
?from\_OpportunityType\_UpdatedOn=...
{% endapi-method-parameter %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/crm/opportunitytypes?OpportunityType_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}

{% api-method-description %}
Gets one or more opportunitytype records based on their Id.
{% endapi-method-description %}
...
Comma-separated list of IDs of every opportunitytype to fetch. I.e. [123456,789102,...] 
{% endapi-method-parameter %}

...
{% api-method-description %}
This endpoint allows you to GET a list of roles.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/security/roles?Role_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}

{% api-method-description %}
Gets one or more role records based on their Id.
{% endapi-method-description %}
...
Comma-separated list of IDs of every role to fetch. I.e. [123456,789102,...] 
{% endapi-method-parameter %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/security/roles/:id" %}
{% api-method-summary %}
One by Id
{% endapi-method-summary %}
...
> 🔒 Requires user role `role-read`


{% api-method method="post" host="https://spaces.nexudus.com/api" path="/security/roles" %}
{% api-method-summary %}
Create
{% endapi-method-summary %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/security/roles/commands" %}
{% api-method-summary %}
Commands
{% endapi-method-summary %}

{% api-method-description %}
Get all commands available to run for role records.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/security/roles/runcommand" %}
{% api-method-summary %}
Run Command
{% endapi-method-summary %}

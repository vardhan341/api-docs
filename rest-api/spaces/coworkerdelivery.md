...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/spaces/coworkerdeliveries?CoworkerDelivery_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}

{% api-method-description %}
Gets one or more coworkerdelivery records based on their Id.
{% endapi-method-description %}
...
Comma-separated list of IDs of every coworkerdelivery to fetch. I.e. [123456,789102,...] 
{% endapi-method-parameter %}

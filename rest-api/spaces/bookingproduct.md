...
{% api-method-description %}
This endpoint allows you to GET a list of bookingproducts.
{% endapi-method-description %}
...
{% api-method-description %}
Gets a list of bookingproducts based on a range of dates, integer or decimal properties.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/spaces/bookingproducts/:id" %}
{% api-method-summary %}
One by Id
{% endapi-method-summary %}

{% api-method-description %}
Gets one bookingproduct record.
{% endapi-method-description %}
...
> 🔒 Requires user role `bookingproduct-create`
...
{% api-method-description %}
Updates and existing bookingproduct.
...
{% api-method-body-parameters %}
The id of the bookingproduct to update
{% api-method-parameter name="BookingId" type="int" required=true %}
{% endapi-method-parameter %}
{% api-method-parameter name="ProductId" type="int" required=true %}
{% endapi-method-parameter %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/spaces/bookingproducts/commands" %}
{% api-method-summary %}
Commands
{% endapi-method-summary %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/spaces/bookingproducts/runcommand" %}
{% api-method-summary %}
Run Command
{% endapi-method-summary %}

...
```javascript
{
    "Records": [{
        ...
        "IsNewMessage": false,
        "Incoming": false,
		"CoworkerMessageCoworkerFullName": "...",
		"CoworkerMessageCoworkerEmail": "...",
		"CoworkerMessageCoworkerBillingName": "...",
		"CoworkerMessageCoworkerCompanyName": "...",
		"CoworkerMessageEmailAccountDisplayName": "...",
		"CoworkerMessageEmailAccountEmailAddress": "...",
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/spaces/coworkermessages?CoworkerMessage_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}
...
{% api-method-description %}
Updates and existing coworkermessage. PUT requests require ALL record properties to be submitted with every request. Any missing properties will be cleared or set to false.

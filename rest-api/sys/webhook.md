...
{% api-method-description %}
This endpoint allows you to GET a list of webhooks.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/sys/webhooks?WebHook_Id=[:id1,:id2,...]" %}
{% api-method-summary %}
List by Ids
{% endapi-method-summary %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/sys/webhooks/:id" %}
{% api-method-summary %}
One by Id
{% endapi-method-summary %}
...
> 🔒 Requires user role `webhook-read`


{% api-method method="post" host="https://spaces.nexudus.com/api" path="/sys/webhooks" %}
{% api-method-summary %}
Create
{% endapi-method-summary %}
...
{% endapi-method-parameter %}
{% api-method-parameter name="Action" type="enum" required=false %}
{% endapi-method-parameter %}
...
{% api-method-description %}
Updates and existing webhook. PUT requests require ALL record properties to be submitted with every request. Any missing properties will be cleared or set to false.
  
Required User Role: `webhook-edit`
{% endapi-method-description %}
...
{% api-method-parameter name="Name" type="string" required="true" %}
{% endapi-method-parameter %}
{% api-method-parameter name="Action" type="enum" required="true" %}
{% endapi-method-parameter %}
...
Required User Roles: `webhook-delete`
{% endapi-method-description %}
...
> 🔒 Requires user role `webhook-delete`
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/sys/webhooks/commands" %}
{% api-method-summary %}
Commands
{% endapi-method-summary %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/sys/webhooks/runcommand" %}
{% api-method-summary %}
Run Command
{% endapi-method-summary %}

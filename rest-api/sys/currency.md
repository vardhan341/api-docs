...
{% api-method-description %}
This endpoint allows you to GET a list of currencies.
{% endapi-method-description %}
...
{% api-method-description %}
Gets a list of currencies based on a range of dates, integer or decimal properties.
{% endapi-method-description %}
...
?to\_Currency\_CreatedOn=...
{% endapi-method-parameter %}

{% api-method-parameter name="CreatedOn" type="object" required=false %}
?from\_Currency\_CreatedOn=...
{% endapi-method-parameter %}

{% api-method-parameter name="UpdatedOn" type="object" required=false %}
?to\_Currency\_UpdatedOn=...
{% endapi-method-parameter %}
...
{% api-method-description %}
Gets one or more currency records based on their Id.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/sys/currencies/commands" %}
{% api-method-summary %}
Commands
{% endapi-method-summary %}

{% api-method-description %}
Get all commands available to run for currency records.
{% endapi-method-description %}
...
{% api-method method="get" host="https://spaces.nexudus.com/api" path="/sys/currencies/runcommand" %}
{% api-method-summary %}
Run Command
{% endapi-method-summary %}
